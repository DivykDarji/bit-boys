      ...
      <main style={dashboardStyles.wrapper}>
        <div style={dashboardStyles.applicationSection}>
          <h2 style={{ marginBottom: 30 }}>
            Trust Level: {wallet?.trustLevel || "Basic"}
          </h2>
          ...
          <div style={dashboardStyles.grid}>
            ...
            <SectorCard
              ...
              actionLabel={
                wallet?.health?.verified ? null : "Link Health Provider"
              }
              onAction={() => navigate("/provider-auth/health")}
              bgColor={colors.sage}
              textColor="#ffffff"
              icon={<HealthIcon />}
            />
            ...
            <SectorCard
              ...
              actionLabel={
                wallet?.farm?.verified ? null : "Link Agriculture Registry"
              }
              onAction={() => navigate("/provider-auth/farm")}
              bgColor={colors.wood}
            ...
            <SectorCard
              ...
              actionLabel={
                wallet?.city?.verified ? null : "Link City Registry"
              }
              onAction={() => navigate("/provider-auth/city")}
